    ...
    <h4>Formulário de Cadastro de Alunos</h4>
      ...
      <form action="alunos_insert.php" method="post" style="margin-top: 20px">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="data de nascimento" autocomplete="off" name="data de nascimento" placeholder="Digite a Data de Nascimento" required>
        </div>
        <div class="form-group">
          <label>Matrícula</label>
          <input type="text" class="form-control" id="matricula" name="matricula" placeholder="Digite a Matrícula do Aluno" autocomplete="off" required>
        </div>
